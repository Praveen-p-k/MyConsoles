...
function Check_return (name, gender)
{
    let ptr = head ;
    ...
    ptr.mom = ptr.dad = ptr.sibbling = ptr.child = ptr.nxt = null ;
...
function Push (name, gender, mom, dad)
{
    let ptr ;
...
function Find_Patner (grand, gender, self_gen) 
{
    let ptr = grand.child ;
